...
const foodData=FoodApi
  ...
  return (
    <div className="w-screen p-2 ">
        <Hero/>
        <div className='p-3 lg:flex-row grid-flow-row items-center grid lg:grid-flow-col lg:grid-rows-3'>
            ...
            <div className="flex mt-4 text-cyan-500 lg:flex flex-col items-center justify-center">
              <Link>Next  {'>>'}</Link>
            </div>
        </div>
    </div>
